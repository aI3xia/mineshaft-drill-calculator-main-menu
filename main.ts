...
const Resources: Record<string, Resource> = {
  drillCalculator: {
    ...
    color: "blue",
    available: true,
    url: "https://industrialist-wiki.github.io/mineshaft-drill-calculator/",
  },
  recipeBrowser: {
    id: "recipe-browser",
    title: "Recipe Browser",
    description:
      "Search and browse all crafting recipes, production chains, and item information.",
    iconClass: "book-icon",
    color: "green",
    available: false,
  },
  productionPlanner: {
    ...
    description:
      "Plan and optimize your factory production lines and resource chains.",
  ...
  powerCalculator: {
    ...
    description:
      "Calculate power requirements and design efficient power distribution systems.",
    iconClass: "zap-icon",
    color: "yellow",
    available: false,
  },
